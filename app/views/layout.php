                ...
                <div class="flex flex-col h-full md:pl-8">
                    ...
                    <ul class="space-y-3 text-sm text-primary-200">
                        <li class="flex items-start gap-3">
                            ...
                            <span>P.O. Box 4, Kikam, Western Region, Ghana<br>Takoradi Elubo Road, Kikam</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span>
                                <a href="mailto:Kimtechmail@yahoo.com" class="hover:text-white transition-colors">Kimtechmail@yahoo.com</a><br>
                                <a href="mailto:kikamtechinst@ges.gov.gh" class="hover:text-white transition-colors">kikamtechinst@ges.gov.gh</a>
                            </span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg class="w-5 h-5 text-accent-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                            <span>
                                <a href="tel:+233546561424" class="hover:text-white transition-colors">+233 54 656 1424</a><br>
                                <a href="tel:+233542202670" class="hover:text-white transition-colors">+233 54 220 2670</a><br>
                                <a href="tel:+233244380894" class="hover:text-white transition-colors">+233 24 438 0894</a>
                            </span>
                        </li>
                    </ul>
                </div>
